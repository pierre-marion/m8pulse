...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.6Ygf1.m'] ?? self::get_ServiceLocator_6Ygf1_MService($container)), ($container->privates['.service_locator.8GlXtTV'] ?? $container->load('get_ServiceLocator_8GlXtTVService')), ['api' => [($container->privates['debug.security.authenticator.jwt.api'] ?? $container->load('getDebug_Security_Authenticator_Jwt_ApiService')), ($container->privates['debug.security.authenticator.json_login.api'] ?? $container->load('getDebug_Security_Authenticator_JsonLogin_ApiService'))]], false);
