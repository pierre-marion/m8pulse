...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'datasets' => [parent::class, 'datasets', null, 16],
        ...
        "\0".parent::class."\0".'subscriptionLevel' => [parent::class, 'subscriptionLevel', null, 16],
        ...
        'datasets' => [parent::class, 'datasets', null, 16],
        ...
        'subscriptionLevel' => [parent::class, 'subscriptionLevel', null, 16],
