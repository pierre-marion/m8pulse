...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\DatasetController' => 'getDatasetControllerService',
            'App\\Controller\\GoogleSheetsController' => 'getGoogleSheetsControllerService',
            ...
            'App\\Controller\\VisualizationController' => 'getVisualizationControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ArticleController', 'App\\Controller\\AuthController', 'App\\Controller\\BlockController', 'App\\Controller\\CommentController', 'App\\Controller\\DatasetController', 'App\\Controller\\GoogleSheetsController', 'App\\Controller\\MediaController', 'App\\Controller\\PlayerController', 'App\\Controller\\RatingController', 'App\\Controller\\ThemeController', 'App\\Controller\\UserController', 'App\\Controller\\VisualizationController', 'App\\Controller\\WelcomeController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\ArticleVoter'] ?? $container->load('getArticleVoterService'));
            yield 4 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\BlockVoter'] ?? $container->load('getBlockVoterService'));
            yield 5 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\DatasetVoter'] ?? $container->load('getDatasetVoterService'));
            yield 6 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\MediaVoter'] ?? $container->load('getMediaVoterService'));
            yield 7 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\ThemeVoter'] ?? $container->load('getThemeVoterService'));
    ...
    protected static function getSerializerService($container)
    {
        ...
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, [], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer([]), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer([]), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $b), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($c, $b, $d, $e, NULL, [])), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer([]), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, []), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($c, $b, $a, $d, $e, NULL, [], $d)], [new \Symfony\Component\Serializer\Encoder\XmlEncoder([]), new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, []), new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, []), new \Symfony\Component\Serializer\Encoder\CsvEncoder([])], []);
    }
